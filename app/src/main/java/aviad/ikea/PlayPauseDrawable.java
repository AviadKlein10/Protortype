...
public class PlayPauseDrawable extends Drawable {
    ...
    public PlayPauseDrawable(Context context) {
        ...
        mPaint.setColor(res.getColor(R.color.fill_color));
    ...
    public Animator getPlayAnimator(boolean play) {

        return ObjectAnimator.ofFloat(this, PROGRESS, play ? 1 : 0, play ? 0 : 1);
    }
    ...
    public void transformToPlay(boolean animate){
            jumpToCurrentState();
        if(!mIsPlay){
            if(animate){
                toggle();
